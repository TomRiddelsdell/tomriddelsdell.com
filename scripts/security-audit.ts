...
${report.status === 'SECURE' ? '✅ **SECURE**: No production security risks identified' : ''}
${report.status === 'ACCEPTABLE' ? '🟡 **ACCEPTABLE**: Minor risks contained and mitigated' : ''}
${report.status === 'ACTION_REQUIRED' ? '🔴 **ACTION REQUIRED**: Critical vulnerabilities need immediate attention' : ''}
