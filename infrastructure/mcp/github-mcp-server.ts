    ...
    switch (name) {
      ...
      case 'github_setup_cicd_complete':
        ...
        const secrets_to_create = [
          ...
          ['STAGING_DATABASE_URL', args.databaseUrl || 'postgresql://neondb_owner:REDACTED_NEON_PASSWORD@ep-withered-water-a5gynbw9.us-east-2.aws.neon.tech/neondb?sslmode=require'],
          ...
          ['PRODUCTION_DATABASE_URL', args.databaseUrl || 'postgresql://neondb_owner:REDACTED_NEON_PASSWORD@ep-withered-water-a5gynbw9.us-east-2.aws.neon.tech/neondb?sslmode=require'],
        ];
